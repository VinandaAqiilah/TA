...
<head>
    ...
    <title>Admin Penjualan Barang Medis</title>
...
<body>
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand">
                        ...
                        <div class="brand-title">
                            <span class="brand-text">Admin Penjualan</span>
                        </div>
                    </a>
                </div>
                <!--================================-->
                        ...
                        <div class="nano">
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                     ...
                                     <div class="profile-wrap text-center">
                                        ...
                                        <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                            ...
                                            <span class="mnp-desc">adminsaya@gmail.com</span>
                                        </a>
                                    </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <?php if($this->uri->segment('1') == 'data_barang'){ ?>
                                    <li class="active-sub">
                                    ...
                                    <?php if($this->uri->segment('1') == 'customer_biasa'){ ?>
                                    <li class="active-sub active">
                                        ...
                                        <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="<?php echo base_url('customer_biasa'); ?>">Customer Biasa</a></li>
                                            <li class=""><a href="<?php echo base_url('customer_berlangganan'); ?>">Customer Berlangganan</a></li>
                                        </ul>
                                    </li>
                                    <?php }
                                    else if($this->uri->segment('1') == 'customer_berlangganan'){ ?>
                                    <li class="active-sub active">
                                        <a href="#">
                                            <i class="fa fa-user"></i>
                                            <span class="menu-title">Data Customer</span>
                                        ...
                                        <ul class="collapse in">
                                            ...
                                            <li class=""><a href="<?php echo base_url('customer_biasa'); ?>">Customer Biasa</a></li>
                                            <li class="active-link"><a href="<?php echo base_url('customer_berlangganan'); ?>">Customer Berlangganan</a></li>
                                        </ul>
                                    </li>
                                    <?php }
                                    else{ ?>
                                    ...
                                    <li class="active-sub active">
                                        ...
                                        <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="<?php echo base_url('penjualan_barang'); ?>">Penjualan Barang</a></li>
                                            <li class=""><a href="<?php echo base_url('retur_penjualan_barang'); ?>">Retur Penjualan Barang</a></li>
                                        </ul>
                                    </li>
                                    <?php }
                                    else if($this->uri->segment('1') == 'grafik_penjualan'){ ?>
                                    <li class="active-sub active">
                                        <a href="#">
                                            <i class="fa fa-calculator"></i>
                                            <span class="menu-title">Transaksi</span>
                                        ...
                                        <ul class="collapse in">
                                            ...
                                            <li class=""><a href="<?php echo base_url('penjualan_barang'); ?>">Penjualan Barang</a></li>
                                            <li class="active-link"><a href="<?php echo base_url('retur_penjualan_barang'); ?>">Retur Penjualan Barang</a></li>
                                        </ul>
                                    </li>
                                    <?php }
                                    else{ ?>
                                    ...
                                    <li class="active-sub active">
                                        <a href="#">
                                            ...
                                            <span class="menu-title">Data Entry Penjualan</span>
                                            <i class="arrow"></i>
                                        </a>
                                        ...
                                        <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="<?php echo base_url('laporan'); ?>">Laporan</a></li>
                                            <li class=""><a href="<?php echo base_url('grafik_penjualan'); ?>">Grafik Penjualan</a></li>
                                        </ul>
                                    </li>
                                    <?php }
                                    else if($this->uri->segment('1') == 'grafik_penjualan'){ ?>
                                    <li class="active-sub active">
                                        ...
                                        <ul class="collapse in">
                                            ...
                                            <li class=""><a href="<?php echo base_url('laporan'); ?>">Laporan</a></li>
                                            <li class="active-link"><a href="<?php echo base_url('grafik_penjualan'); ?>">Grafik Penjualan</a></li>
                                        </ul>
                                    </li>
                                    <?php }
                                    else{ ?>
        ...
        <footer id="footer">
            ...
            <p class="pad-lft">&#0169; 2020 CV. WUSAN KARYA MANDIRI (WUSAN) </p>
